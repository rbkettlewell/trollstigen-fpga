...
class ISB extends Module {
  ...
  From: (N,11,false,Track), To: (S,11,false,Track),(E,0,false,Track),(W,3,false,Track)
	...
	*/
	...
	io.W.p3 := (io.S.p0 & io.blkBits(8)) | (io.E.p3 & io.blkBits(17)) | (io.N.p11 & io.blkBits(16))
	io.E.p8 := (io.S.p0 & io.blkBits(55)) | (io.W.p8 & io.blkBits(54)) | (io.N.p7 & io.blkBits(63))
	io.N.p0 := (io.S.p0 & io.blkBits(58)) | (io.W.p0 & io.blkBits(66)) | (io.E.p3 & io.blkBits(50))
	io.W.p5 := (io.S.p2 & io.blkBits(25)) | (io.E.p5 & io.blkBits(24)) | (io.N.p9 & io.blkBits(32))
	io.E.p6 := (io.S.p2 & io.blkBits(39)) | (io.W.p6 & io.blkBits(47)) | (io.N.p5 & io.blkBits(46))
	io.N.p2 := (io.S.p2 & io.blkBits(67)) | (io.W.p10 & io.blkBits(42)) | (io.E.p5 & io.blkBits(59))
	io.W.p7 := (io.S.p4 & io.blkBits(33)) | (io.E.p7 & io.blkBits(40)) | (io.N.p7 & io.blkBits(41))
	io.E.p4 := (io.S.p4 & io.blkBits(30)) | (io.W.p4 & io.blkBits(31)) | (io.N.p3 & io.blkBits(38))
	io.N.p4 := (io.S.p4 & io.blkBits(43)) | (io.W.p8 & io.blkBits(51)) | (io.E.p7 & io.blkBits(34))
	io.W.p9 := (io.S.p6 & io.blkBits(48)) | (io.E.p9 & io.blkBits(49)) | (io.N.p5 & io.blkBits(56))
	io.E.p2 := (io.S.p6 & io.blkBits(15)) | (io.W.p2 & io.blkBits(22)) | (io.N.p1 & io.blkBits(23))
	io.N.p6 := (io.S.p6 & io.blkBits(44)) | (io.W.p6 & io.blkBits(36)) | (io.E.p9 & io.blkBits(52))
	io.W.p11 := (io.S.p8 & io.blkBits(57)) | (io.E.p11 & io.blkBits(64)) | (io.N.p3 & io.blkBits(65))
	io.E.p0 := (io.S.p8 & io.blkBits(6)) | (io.W.p0 & io.blkBits(7)) | (io.N.p11 & io.blkBits(14))
	io.N.p8 := (io.S.p8 & io.blkBits(68)) | (io.W.p4 & io.blkBits(60)) | (io.E.p11 & io.blkBits(45))
	io.W.p1 := (io.S.p10 & io.blkBits(1)) | (io.E.p1 & io.blkBits(0)) | (io.N.p1 & io.blkBits(9))
	...
	io.S.p9 := (io.W.p10 & io.blkBits(12)) | (io.E.p1 & io.blkBits(29)) | (io.N.p9 & io.blkBits(4))
}
