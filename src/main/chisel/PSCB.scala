...
class PSCB extends Module {
  ...
  */
  ...
  io.W.p3 := (io.S.p1 & io.blkBits(7))
  io.E.p4 := (io.S.p1 & io.blkBits(8))
  io.W.p5 := (io.S.p1 & io.blkBits(9))
  io.E.p6 := (io.N.p6 & io.blkBits(10))
  io.W.p7 := (io.N.p6 & io.blkBits(11))
  io.E.p8 := (io.N.p6 & io.blkBits(12))
