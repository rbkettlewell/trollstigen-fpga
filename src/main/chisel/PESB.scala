...
From: (N,11,false,Track), To: (W,11,false,Track),(S,11,false,Track)
	*/
	...
	io.S.p7 := (io.W.p6 & io.blkBits(19)) | (io.N.p7 & io.blkBits(31))
	io.S.p9 := (io.W.p8 & io.blkBits(21)) | (io.N.p9 & io.blkBits(33))
	io.S.p11 := (io.W.p10 & io.blkBits(23)) | (io.N.p11 & io.blkBits(35))
