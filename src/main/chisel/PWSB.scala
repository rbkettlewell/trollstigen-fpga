...
class PWSB extends Module {
  ...
  From: (N,11,false,Track), To: (E,10,false,Track),(S,11,false,Track)
	*/
	...
	io.E.p0 := (io.S.p0 & io.blkBits(0)) | (io.N.p1 & io.blkBits(24))
	io.N.p0 := (io.S.p0 & io.blkBits(1)) | (io.E.p1 & io.blkBits(13))
	io.E.p2 := (io.S.p2 & io.blkBits(2)) | (io.N.p3 & io.blkBits(26))
	io.N.p2 := (io.S.p2 & io.blkBits(3)) | (io.E.p3 & io.blkBits(15))
	io.E.p4 := (io.S.p4 & io.blkBits(4)) | (io.N.p5 & io.blkBits(28))
	io.N.p4 := (io.S.p4 & io.blkBits(5)) | (io.E.p5 & io.blkBits(17))
	io.E.p6 := (io.S.p6 & io.blkBits(6)) | (io.N.p7 & io.blkBits(30))
	io.N.p6 := (io.S.p6 & io.blkBits(7)) | (io.E.p7 & io.blkBits(19))
	io.E.p8 := (io.S.p8 & io.blkBits(8)) | (io.N.p9 & io.blkBits(32))
