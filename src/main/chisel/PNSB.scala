...
class PNSB extends Module {
  ...
  /*
	...
	*/
	io.W.p1 := (io.S.p0 & io.blkBits(1)) | (io.E.p1 & io.blkBits(0))
	io.E.p0 := (io.S.p0 & io.blkBits(6)) | (io.W.p0 & io.blkBits(7))
	io.W.p3 := (io.S.p2 & io.blkBits(8)) | (io.E.p3 & io.blkBits(17))
	io.E.p2 := (io.S.p2 & io.blkBits(15)) | (io.W.p2 & io.blkBits(22))
	io.W.p5 := (io.S.p4 & io.blkBits(25)) | (io.E.p5 & io.blkBits(24))
	io.E.p4 := (io.S.p4 & io.blkBits(30)) | (io.W.p4 & io.blkBits(31))
	io.W.p7 := (io.S.p6 & io.blkBits(33)) | (io.E.p7 & io.blkBits(40))
	io.E.p6 := (io.S.p6 & io.blkBits(39)) | (io.W.p6 & io.blkBits(47))
	io.W.p9 := (io.S.p8 & io.blkBits(48)) | (io.E.p9 & io.blkBits(49))
	io.E.p8 := (io.S.p8 & io.blkBits(55)) | (io.W.p8 & io.blkBits(54))
	io.W.p11 := (io.S.p10 & io.blkBits(57)) | (io.E.p11 & io.blkBits(64))
	io.E.p10 := (io.S.p10 & io.blkBits(62)) | (io.W.p10 & io.blkBits(71))
	io.S.p1 := (io.W.p0 & io.blkBits(2)) | (io.E.p1 & io.blkBits(18))
	io.S.p3 := (io.W.p2 & io.blkBits(26)) | (io.E.p3 & io.blkBits(11))
	io.S.p5 := (io.W.p4 & io.blkBits(19)) | (io.E.p5 & io.blkBits(35))
	io.S.p7 := (io.W.p6 & io.blkBits(37)) | (io.E.p7 & io.blkBits(20))
	io.S.p9 := (io.W.p8 & io.blkBits(12)) | (io.E.p9 & io.blkBits(29))
	io.S.p11 := (io.W.p10 & io.blkBits(21)) | (io.E.p11 & io.blkBits(5))
